//
//  PatternDetailViewControlleriPhone.m
//  iRein
//
...
@interface PatternDetailViewControlleriPhone ()
...
@implementation PatternDetailViewControlleriPhone
...
- (void)viewDidLoad
{
    ...
    //I can delete this when going to this class from large pattern view.
    //patternNumber.text = [[NSString alloc] initWithFormat:@"%d", (self.selectedRow + 1)];
    //[self loadBlackPatternImage:self.selectedRow];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *CellIdentifier = @"ManeuverCell";
    ManeuverCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
...
-(void)loadBlackPatternImage:(NSInteger)rowNumber {
 ...
 - (void)configureCell:(ManeuverCell *)cell atIndexPath:(NSIndexPath *)indexPath {
     ...
     //NSLog(@"The patternNumber text is %@", self.patternNumber.text);
