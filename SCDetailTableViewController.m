...
@interface SCDetailTableViewController ()

@end

@implementation SCDetailTableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    //TODO: Fix This
    if ([[segue identifier] isEqualToString:@"ScorecardContestantSegue"]) {
        
        SCManeuverTableViewController *mySCManeuverTableViewController = [segue destinationViewController];
        mySCManeuverTableViewController.managedObjectContext = self.managedObjectContext;
